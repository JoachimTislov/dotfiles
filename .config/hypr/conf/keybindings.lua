...
hl.bind("SUPER + CTRL + H", hl.dsp.exec_cmd("python ~/.config/hypr/scripts/focus-floating.py h"), { description = "Focus floating window left", repeating = true })
hl.bind("SUPER + CTRL + J", hl.dsp.exec_cmd("python ~/.config/hypr/scripts/focus-floating.py j"), { description = "Focus floating window down", repeating = true })
hl.bind("SUPER + CTRL + K", hl.dsp.exec_cmd("python ~/.config/hypr/scripts/focus-floating.py k"), { description = "Focus floating window up", repeating = true })
hl.bind("SUPER + CTRL + L", hl.dsp.exec_cmd("python ~/.config/hypr/scripts/focus-floating.py l"), { description = "Focus floating window right", repeating = true })
...
hl.bind("SUPER + CTRL + P", hl.dsp.exec_cmd("pavucontrol"), { description = "Open volume control" })
...
hl.bind("SUPER + SHIFT + V", hl.dsp.exec_cmd("~/.config/hypr/scripts/record-screen.sh"), { description = "Start or stop a screen recording" })
...
hl.bind("SUPER + O", hl.dsp.exec_cmd("~/.config/hypr/scripts/window-switcher.sh"), { description = "Choose an open window" })
hl.bind("SUPER + CTRL + F1", hl.dsp.exec_cmd("~/.config/hypr/scripts/keybindings.sh"), { description = "Show keybindings" })
hl.bind("SUPER + SHIFT + B", hl.dsp.exec_cmd("~/.config/hypr/scripts/restart-waybar.sh"), { description = "Reload waybar" })
