...
hl.bind("SUPER + B", hl.dsp.exec_cmd("firefox"), { description = "Open the browser" })
hl.bind("SUPER + E", hl.dsp.exec_cmd("dolphin --new-window"), { description = "Open the filemanager" })
...
hl.bind("SUPER + CTRL + RETURN", hl.dsp.exec_cmd("rofi -show drun -replace -i -run-command \"uwsm app -- {cmd}\""), { description = "Open application launcher" })
